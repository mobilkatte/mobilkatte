...
function photoFallback() {
  return "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(
    '<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#12334d"/><stop offset="1" stop-color="#1b4b6e"/></linearGradient></defs><rect width="800" height="600" fill="url(#g)"/><text x="400" y="330" font-family="Arial" font-size="34" fill="rgba(255,255,255,.9)" text-anchor="middle">MOBIL KATTE</text></svg>'
  );
}
